  ...
  return (
    <section className="vx-section-seams vx-section-pad lg:py-16 xl:py-20">
      <div className="relative z-10">
        {/* Header */}
        <div className="max-w-[1280px] lg:max-w-[1440px] mx-auto px-5 sm:px-6 lg:px-12 xl:px-16 opacity-0 md:opacity-100 animate-mobile-enter">
          <div className="flex flex-col items-center gap-2 lg:gap-3">
            <span className="vx-tag text-white/20 lg:text-white/25 mb-1 lg:mb-1.5">ARCHIVE</span>
            <h2 className="vx-section-title text-center lg:text-[32px] xl:text-[36px] lg:tracking-[0.28em]">
              КОЛЛЕКЦИИ
            </h2>
            <p className="hidden lg:block text-[11px] text-white/25 tracking-[0.2em] uppercase mt-1 max-w-lg text-center">
              Лимитированные дропы и архивные коллекции
            </p>
          </div>
        </div>
        ...
        >
          {collections.map((col) => (
            <Link
              ...
              prefetch={false}
              className="group shrink-0 snap-start w-[78vw] max-w-[480px] sm:w-[480px] lg:w-[500px] xl:w-[520px] outline-none focus-visible:ring-1 focus-visible:ring-white/20 rounded-xl lg:rounded-2xl flex flex-col transition-all duration-300 lg:hover:scale-[1.01]"
            >
              <div className="relative aspect-[4/3] overflow-hidden rounded-xl lg:rounded-2xl border border-white/[0.06] lg:border-white/[0.08] bg-[#0B0D10] transition-all duration-400 group-hover:border-white/[0.12] lg:group-hover:border-white/[0.15]">
                <FadeImage
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 lg:p-6">
                  <span className="text-[10px] lg:text-[11px] font-mono uppercase tracking-[0.28em] lg:tracking-[0.3em] text-white/60 lg:text-white/70 block">
                    {col.label ?? col.tag}
                  </span>
                </div>
              </div>
        ...
        {/* Progress indicator */}
        <div className="max-w-[1280px] lg:max-w-[1440px] mx-auto px-5 sm:px-6 lg:px-12 xl:px-16 mt-6 lg:mt-8">
